...
export default function EditStoreProfile({ user }: { user: any }) {
  ...
  return (
    <>
      <Paper shadow="xl" withBorder className="p-16" h={rem(630)}>
        <Stack spacing="xs">
          <p className="text-2xl font-semibold">My Store Profile</p>
          <p className="text-slate-400">Manage your store information</p>
          <Divider />
        </Stack>
